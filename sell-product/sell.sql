...
create table `product_category` (
                                  ...
                                  `category_name` nvarchar(64) not null comment '类目名字',
...
create table `product_info` (
                              ...
                              `product_name` nvarchar(64) not null comment '商品名称',
                              `product_price` decimal(8,2) not null comment '单价',
                              `product_stock` int not null comment '库存',
                              `product_description` nvarchar(64) comment '描述',
                              `product_icon` nvarchar(512) comment '小图',
...
create table `order_master` (
                              ...
                              `buyer_name` nvarchar(32) not null comment '买家名字',
                              `buyer_phone` nvarchar(32) not null comment '买家电话',
                              `buyer_address` nvarchar(128) not null comment '买家地址',
                              `buyer_openid` nvarchar(64) not null comment '买家微信openid',
...
create table `order_detail` (
                              `detail_id` nvarchar(32) not null,
                              `order_id` nvarchar(32) not null,
                              `product_id` nvarchar(32) not null,
                              `product_name` nvarchar(64) not null comment '商品名称',
...
CREATE TABLE `user_info` (
                           ...
                           `username` nvarchar(32) DEFAULT '',
                           `password` nvarchar(32) DEFAULT '',
                           `openid` nvarchar(64) DEFAULT '' COMMENT '微信openid',
